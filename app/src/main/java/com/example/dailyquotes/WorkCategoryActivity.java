...
public class WorkCategoryActivity extends AppCompatActivity {
    ...
    ArrayList<mainfeed> workAL=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        workAL.add(new mainfeed("\"\"",R.mipmap.p9));

        adapter=new QuotesAdapter(getApplicationContext(),workAL);
        workRV.setHasFixedSize(true);
        workRV.setLayoutManager(new LinearLayoutManager(this));
        workRV.setAdapter(adapter);
    }
